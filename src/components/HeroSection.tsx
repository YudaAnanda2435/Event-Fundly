      ...
      <div className="container mx-auto px-6 md:px-20 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0">
          <div className="space-y-7 text-white w-full md:w-1/2">
            <h1 className="text-4xl md: text-[96px] md:text-7xl font-medium font-fontJakarta mt-32 md: whitespace-nowrap">
              <span className="text-blue-500">SMART</span>-SAVINGS
              <br />
              PLANNED-EVENTS
            </h1>
            <p className="text-gray-400 text-[16px] text-justify font-fontJakarta cursor-pointer">
            ...
            <div>
              <Link
                to="/signup"
                className="text-gray-900 font-fontJakarta hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800"
              >
                Get Started
              </Link>
            </div>
